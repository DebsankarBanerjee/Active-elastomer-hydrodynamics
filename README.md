...
This repository contains the numerical implementation of the continuum model for active actomyosin elastomers using the finite volume method, as described in [Nature Communications (2017)](https://www.nature.com/articles/s41467-017-01130-1).
